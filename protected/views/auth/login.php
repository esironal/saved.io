  ...
  <div class="page-heading">
    <div class="row">
      <div class="large-8 columns ">
          ...
          <a href="<?php echo $this->createUrl('auth/register') ?>"><img src="img/browser.png"></a>
          ...
          <a href="<?php echo $this->createUrl('auth/register') ?>"><img class="viewimg" src="img/front.png"></a>
            </div>  
      
      <div class="large-4 columns">
        <div class="login-link">
        <a href="#" data-dropdown="drop2">Login</a><a class="alittleright" href="<?php echo $this->createUrl('auth/register') ?>">Register</a>
        <div id="drop2" class="f-dropdown content" data-dropdown-content>
            ...
            <form name="form1" method="post" action="">
              ...
              <span style="float:left;"><a href="<?php echo $this->createUrl('auth/preset') ?>">Forgot your pasword?</a></span> <input type="submit" name="login" class="small button secondary" value="Login">
            </form>
